        ...
        uint32_t b) 
{
    ...
    int32_t 
        x0 = f0 ^ g0, x1 = f1 ^ g1, x2 = f2 ^ g2,
        x3 = f3 ^ g3, x4 = f4 ^ g4, x5 = f5 ^ g5,
        x6 = f6 ^ g6, x7 = f7 ^ g7, x8 = f8 ^ g8,
        x9 = f9 ^ g9;

    b = (uint32_t)(- (int)b); /* silence warning */
    x0 &= b;
    x1 &= b;
    x2 &= b;
    x3 &= b;
...
void spake2__fe_frombytes(
        ...
        const uint8_t *s) 
{
    int64_t h0 = spake2__load4(s);
    int64_t h1 = spake__load3(s + 4) << 6;
    int64_t h2 = spake__load3(s + 7) << 5;
    int64_t h3 = spake__load3(s + 10) << 3;
    int64_t h4 = spake__load3(s + 13) << 2;
    int64_t h5 = spake2__load4(s + 16);
    int64_t h6 = spake__load3(s + 20) << 7;
    int64_t h7 = spake__load3(s + 23) << 5;
    int64_t h8 = spake__load3(s + 26) << 4;
    int64_t h9 = (spake__load3(s + 29) & 8388607) << 2;
    int64_t carry;
