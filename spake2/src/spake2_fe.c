...
static uint64_t spake2__load3(const unsigned char *in) {
    uint64_t result;
...
static uint64_t spake2__load4(const unsigned char *in) {
    uint64_t result;
...
void spake2__fe_frombytes(spake2__fe_t h, const unsigned char *s) {
    int64_t 
        h0 = 0, h1 = 0, h2 = 0, 
        h3 = 0, h4 = 0, h5 = 0, 
        h6 = 0, h7 = 0, h8 = 0, 
    ...
    h0 = (int64_t)spake2__load4(s);
    h1 = (int64_t)(spake2__load3(s + 4) << 6);
    h2 = (int64_t)(spake2__load3(s + 7) << 5);
    h3 = (int64_t)(spake2__load3(s + 10) << 3);
    h4 = (int64_t)(spake2__load3(s + 13) << 2);
    h5 = (int64_t)spake2__load4(s + 16);
    h6 = (int64_t)(spake2__load3(s + 20) << 7);
    h7 = (int64_t)(spake2__load3(s + 23) << 5);
    h8 = (int64_t)(spake2__load3(s + 26) << 4);
    h9 = (int64_t)((spake2__load3(s + 29) & 8388607) << 2);

    carry = (h9 + (int64_t)(1 << 24)) >> 25; h0 += carry * 19; h9 -= carry << 25;
    carry = (h1 + (int64_t)(1 << 24)) >> 25; h2 += carry;      h1 -= carry << 25;
    carry = (h3 + (int64_t)(1 << 24)) >> 25; h4 += carry;      h3 -= carry << 25;
    carry = (h5 + (int64_t)(1 << 24)) >> 25; h6 += carry;      h5 -= carry << 25;
    carry = (h7 + (int64_t)(1 << 24)) >> 25; h8 += carry;      h7 -= carry << 25;
    carry = (h0 + (int64_t)(1 << 25)) >> 26; h1 += carry;      h0 -= carry << 26;
    carry = (h2 + (int64_t)(1 << 25)) >> 26; h3 += carry;      h2 -= carry << 26;
    carry = (h4 + (int64_t)(1 << 25)) >> 26; h5 += carry;      h4 -= carry << 26;
    carry = (h6 + (int64_t)(1 << 25)) >> 26; h7 += carry;      h6 -= carry << 26;
    carry = (h8 + (int64_t)(1 << 25)) >> 26; h9 += carry;      h8 -= carry << 26;
...
void spake2__fe_invert(spake2__fe_t out, const spake2__fe_t z) {
    spake2__fe_t t0;
    spake2__fe_t t1;
    spake2__fe_t t2;
    spake2__fe_t t3;
...
int spake2__fe_isnegative(const spake2__fe_t f) {
    unsigned char s[32];
...
void spake2__fe_mul(spake2__fe_t h, const spake2__fe_t f, const spake2__fe_t g) {
    int32_t f0 = f[0];
    int32_t f1 = f[1];
    int32_t f2 = f[2];
    int32_t f3 = f[3];
...
void spake2__fe_mul121666(spake2__fe_t h, spake2__fe_t f) {
    int32_t f0 = f[0];
    int32_t f1 = f[1];
    int32_t f2 = f[2];
    int32_t f3 = f[3];
...
void spake2__fe_neg(spake2__fe_t h, const spake2__fe_t f) {
    int32_t f0 = f[0];
    int32_t f1 = f[1];
    int32_t f2 = f[2];
    int32_t f3 = f[3];
...
void spake2__fe_pow22523(spake2__fe_t out, const spake2__fe_t z) {
    spake2__fe_t t0;
    spake2__fe_t t1;
    spake2__fe_t t2;
    int i;
...
void spake2__fe_sq2(spake2__fe_t h, const spake2__fe_t f) {
    int32_t f0 = f[0];
    int32_t f1 = f[1];
    int32_t f2 = f[2];
    int32_t f3 = f[3];
